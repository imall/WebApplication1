...
namespace WebApplication1.Models
{
    public partial interface IContosoUniversityContextProcedures
    {
        ...
        Task<List<GetCoursesByTitleStartOrEndResult>> GetCoursesByTitleStartOrEndAsync(string Something, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
    }
}
