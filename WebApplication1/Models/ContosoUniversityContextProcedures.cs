...
namespace WebApplication1.Models
{
    ...
    public partial class ContosoUniversityContextProcedures : IContosoUniversityContextProcedures
    {
        ...
        public virtual async Task<int> Department_DeleteAsync(int? DepartmentID, byte[] RowVersion_Original, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[Department_Delete] @DepartmentID = @DepartmentID, @RowVersion_Original = @RowVersion_Original", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<Department_InsertResult>> Department_InsertAsync(string Name, decimal? Budget, DateTime? StartDate, int? InstructorID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<Department_InsertResult>("EXEC @returnValue = [dbo].[Department_Insert] @Name = @Name, @Budget = @Budget, @StartDate = @StartDate, @InstructorID = @InstructorID", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<Department_UpdateResult>> Department_UpdateAsync(int? DepartmentID, string Name, decimal? Budget, DateTime? StartDate, int? InstructorID, byte[] RowVersion_Original, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<Department_UpdateResult>("EXEC @returnValue = [dbo].[Department_Update] @DepartmentID = @DepartmentID, @Name = @Name, @Budget = @Budget, @StartDate = @StartDate, @InstructorID = @InstructorID, @RowVersion_Original = @RowVersion_Original", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<GetCoursesByTitleStartOrEndResult>> GetCoursesByTitleStartOrEndAsync(string Something, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<GetCoursesByTitleStartOrEndResult>("EXEC @returnValue = [dbo].[GetCoursesByTitleStartOrEnd] @Something = @Something", sqlParameters, cancellationToken);
